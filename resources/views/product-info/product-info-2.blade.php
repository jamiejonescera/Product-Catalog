...
<div class="row d-flex align-items-center mx-auto" style="width: 80%;">
        ...
        <div id="carouselExampleIndicators" class="carousel slide">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="{{ asset('media/apparel-product/shirt-2-front.png') }}" class="d-block w-100" alt="...">
            </div>
  ...
  <div class="col-sm-6 ">
    <div class="card">
      <div class="card-body">
        <h3 class="card-title">Pixel Princess T-Shirt</h5>
        <h4>PHP 180.00</h4>
        <h5> Color </h5>
        <div class="text-center">
          <button type="button" class="btn btn-outline-secondary" data-bs-toggle="button">Yellow</button>
        </div>
        <h5> Size </h5>
        <div class="text-center">
